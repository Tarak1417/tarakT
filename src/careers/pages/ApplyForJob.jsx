            ...
            <form className="w-full mb-8" onSubmit={handleSubmit}>
                ...
                <div className="formInputGrid gap-20 mb-6">
                    <div className="mb-4">
                        ...
                        <input className="shadow appearance-none border rounded-lg placeholder-gray-600 w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline dark:bg-[#141414] dark:text-white dark:border-slate-600 dark:placeholder-slate-600" id="company" type="text" placeholder="Enter Company Name" required/>
                    </div>
                    <div className="mb-4">
