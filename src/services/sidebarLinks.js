...
const menuItems = [
    ...
    },
    {
        ...
        to: [
            {
                label: 'Landing Pages',
                icon: <TripOriginIcon  style={{height:'15px'}}  />,
                
                to: [
                    {
                        label:  <TagSupport />,
                        icon: <TripOriginIcon  style={{height:'12px'}} />,
                        to: '/support/landing',
                    },
                    {
                        label: <TagSupport2/>,
                        ...
                        to: [
                            {
                                label: <TagSupport6/> ,
                                icon: <TripOriginIcon  style={{height:'12px'}} />,
                                to: '/support/ticketlist',
                            },
                            {
                                label: <TagSupport7/> ,
                                icon: <TripOriginIcon  style={{height:'12px'}} />,
                                to: '/support/activeticket',
                            },
                            {
                                label: <TagSupport8/> ,
                                icon: <TripOriginIcon  style={{height:'12px'}} />,
                                to: '/support/createtiket',
                            },
                            {
                                label:<TagSupport9/> ,
                                icon: <TripOriginIcon  style={{height:'12px'}} />,
                                to: '/support/closeticket',
                            },
                            {
                                label: <TagSupport10/> ,
                                icon: <TripOriginIcon  style={{height:'12px'}} />,
