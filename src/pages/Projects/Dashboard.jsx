...
function Dashboard() {
  ...
  const boxesData1 = [
    {
      icon: (
        <img alt="" className="w-[50px] h-[50px]" src={figmaicon} />
        // <img
    ...
    {
      icon: (
        <img alt="" className="w-[50px] h-[50px]" src={htmlicon} />
    ...
    {
      icon: (
        <img alt="" className="w-[50px] h-[50px]" src={adobeicon} />
        //         <img
    ...
    {
      icon: (
        <img alt="" className="w-[50px] h-[50px]" src={fluttericon} />
        //         <img
    ...
    <Box sx={{ backgroundColor: "background.main" }}>
      <div className="flex flex-col">
        <div className="p-2">
            ...
            <div className="w-full md:w-4/4">
              <div className="flex flex-col gap-4 mb-4 md:flex-row">
                {boxesData.map((box, index) => (
                  ...
                  >
                    <p className="text-[15px] font-[500] leading-[19.53px] md:text-xl">
                      {box.title}
                    </p>
          ...
          <div className="p-2">
            <Typography className="text-[20px] font-[500] leading-[26.04px] md:text-2xl md:text-neutral-500">
                ...
                {boxesData1.map((box, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center mb-[16px] mt-[-9px]">
                      <p className="text-[10px] leading-[13.02px] font-[400] w-5/6 ">
                        {" "}
                        {(() => {
                    ...
                    <div className="flex items-center justify-between gap-2 mt-2">
                      ...
                      >
                        ...
                        <p
                          ...
                          className="p-2 font-[400]  leading-[15.6px] "
                        >
                          Low
                        </p>{" "}
                        <span>
