    ...
    return(
        ...
        <div className='w-full flex flex-col gap-10'>
            <div className='w-full flex justify-center items-center'>
                <h1 className='text-center text-3xl font-bold text-white'>EMPLOYMENT CONTRACT AGREEMENT</h1>
            </div>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>DUTIES AND RESPONSIBILITIES</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
                    During the employment period, the Employee shall have the responsibility to perform the following duties:
                </p>
                <p className='text-[14px] text-white pt-4 pl-6'>1.Building user interface using ReactJS, from design given by the UX team.</p>
                <p className='text-[14px] text-white pl-6'>2.Ensuring user interface works across a variety of devices and browsers</p>
                <p className='text-[14px] text-white pl-6'>3.Creating REST APIs using Open API specification on NodeJS.</p>
                <p className='text-[14px] text-white pl-6'>4.Robust test-driven development with unit tests and integration tests.</p>
                <p className='text-[14px] text-white pl-6'>5.Creating highly scalable backend, load tested and ready to deploy on the cloud.</p>
                <p className='text-[14px] text-white pl-6'>6.Creating resilient code using MongoDB, Elasticsearch, Redis.</p>
                <p className='text-[14px] text-white pl-6'>7.Integrating user interface with various iManage products.</p>
                <p className='text-[14px] text-white pt-4 pl-6'>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>PAY AND COMPENSATION</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
                    The Parties hereby agree that the Employer will pay the Employee an annual salary of <span className='pl-2 pr-2 text-[14px] font-semi-bold text-white'>36000 CAD</span> payable semi-monthly and subject to regular 
                    deductions and withholdings as required by law
                </p>
                <p className='text-[14px] text-white pt-3  pl-6'>
            ...
            <div className='w-full'>
                ...
                <p className='text-[14px] text-white pt-4 pl-6'>1.Awesome team and culture (every day)</p>
                <p className='text-[14px] text-white pl-6'>2.Generous time off, including vacation and personal days to help rejuvenate</p>
                <p className='text-[14px] text-white pl-6'>3.Extended health benefits, including drug coverage, dental coverage, and a Health Spending Account</p>
                <p className='text-[14px] text-white pl-6'>4.Flexible Work policy, with options to work remotely</p>
                <p className='text-[14px] text-white pl-6'>5.Attend Conferences to extend your knowledge and skills</p>
                <p className='text-[14px] text-white pl-6'>6.Top technology and tools to excel at your role</p>
                <p className='text-[14px] text-white pl-6'>7.annual performance-based bonus.</p>

            </div>
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>WORKING HOURS AND LOCATION</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>TERMS OF AGREEMENT</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>TERMINATION</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
                ...
                <p className='text-[14px] text-white  pl-6'>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>CONFIDENTIALITY</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>EXCLUSIVITY</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>LIMITATIONS OF LIABILITY</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>ALTERNATIVE DISPUTE RESOLUTIONS</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>ATTORNEY FEES</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
