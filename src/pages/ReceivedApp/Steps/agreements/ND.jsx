    ...
    return(
        ...
        <div className='w-full flex flex-col gap-10'>
            <div className='w-full flex justify-center items-center'>
                <h1 className='text-center text-3xl font-bold text-white'>NON-DISCLOSURE AGREEMENT</h1>
            </div>
            <div className='w-full'>
                ...
                <p className='text-[14px] text-white pt-4 pl-6'>
                    ...
                    <span className='pr-2 pl-2 text-[14px] font-bold'>Clikkle Technologies</span> , with an address of 470 King St W #6, Oshawa, ON (hereinafter referred to as the "Receiving Party"), and Name, with an 
                    address of ____________________ (hereinafter referred to as the "Disclosing Party") (collectively referred to as the "Parties")
                </p>
            </div>
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>CONFIDENTIAL INFORMATION</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>RETURN OF CONFIDENTIAL INFORMATION</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
            ...
            <div className='w-full'>
                <h1 className='text-white text-[16px] underline'>OWNERSHIP</h1>
                <p className='text-[14px] text-white pt-4 pl-6'>
