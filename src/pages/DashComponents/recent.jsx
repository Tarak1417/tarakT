        ...
        <div className='bg-neutral-900 rounded-lg mb-4 shadow-md p-4'>
            <div className="flex flex-col md:flex-row gap-4 mb-4 items-center justify-between">
                ...
                <div className="border border-gray-600 rounded-lg p-1">
                    <Typography className="text-sm">View All <KeyboardArrowDownIcon className="cursor-pointer text-9333ea" onClick={toggleDropdown} /></Typography>
                    {dropdownOpen && (
                ...
                {jobs.map((job, index) => (
                    <div key={index} className="mb-4">
                        <div className="flex gap-4 justify-center items-center">
                            ...
                            <div className='w-1/5'>
                                <p className='text-xs text-center text-zinc-500'>just now</p>
                            </div>
                        </div>
                    </div>
                ))}
