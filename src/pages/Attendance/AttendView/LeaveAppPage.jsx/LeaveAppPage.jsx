    ...
    const sectionsData = [
        {
            ...
            date: "02/02/2024",
            remainingLeaves: 12,
            reason: "Lorem ipsum dolor sit amet.Ut blanditiis nemo ea omnis vitae ex dolorem placeat quo velit quod sit saepe ullam id tempora consequatur nam maiores ipsa.",
            apply: "05-01-2024 / 2 weeks ago"
        },
        {
            title: "Earned Leave Request",
            daysLeft: "2 days left",
                            ...
                            <Box className="w-full ml-2 md:ml-0 rounded-lg" sx={{ backgroundColor: 'background.view' }}>
                                ...
                                <div className='flex flex-row gap-2 mx-4'>
                                    ...
                                    <div className='flex flex-col'>
                                        <h1 className='text-[16px]'>{section.name}</h1>
                                        <p className='text-[10px] text-zinc-500'>{section.role}</p>
                                    </div>
                                </div>
                                ...
                                <p className='text-[10px] text-zinc-500 mt-2'>Applied On{section.apply}</p>
                                <LinearProgress variant="determinate" className='mb-2 w-[97%]' value={(section.remainingLeaves / 20) * 100} />
                                </div>
