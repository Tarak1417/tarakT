    ...
    <div className="h-full" style={{ overflowY: 'auto', paddingRight: '1px' }}>
        ...
        <div className='flex flex-col justify-start'>
                ...
                <Box className="flex items-center justify-between md:w-full p-4">
                   ...
                   <SearchIcon style={{ fontSize: '24px', marginLeft: '20px' }} className="text-zinc-500 pr-2 desktop-only" />
                   </div>
                ...
                <Box className='flex justify-between md:w-[100%] align-center  border border-zinc-800 rounded-sm' sx={{ backgroundColor: 'background.view',  borderRadius:'10px' }}>
